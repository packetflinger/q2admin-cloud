...
type Users struct {
	...
	User []*Users_User `protobuf:"bytes,1,rep,name=user,proto3" json:"user,omitempty"`
}
...
func (x *Users_User) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *Users_User) GetDescription() string {
	if x != nil {
...
func (x *Users_User) GetDisabled() bool {
	if x != nil {
		return x.Disabled
	}
	return false
...
var file_user_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xb3, 0x01, 0x0a, 0x05, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x25, 0x0a,
	0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04,
	0x75, 0x73, 0x65, 0x72, 0x1a, 0x82, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x12, 0x0a,
	...
	0x08, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*Users_User)(nil), // 1: proto.Users.User
}
var file_user_proto_depIdxs = []int32{
	1, // 0: proto.Users.user:type_name -> proto.Users.User
